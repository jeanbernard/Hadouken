...
ffmpeg -hide_banner -i videos/downloaded/SF6Yay.mp4 -map 0:v:0 -map 0:a:0 -map 0:v:0 -map 0:a:0 -map 0:v:0 -map 0:a:0 -map 0:v:0 -map 0:a:0 \
-c:v h264 -profile:v main -crf 32 -sc_threshold 0 -g 48 -keyint_min 48 -c:a aac -ar 48000 \
...
-filter:v:1 scale=w=842:h=480:force_original_aspect_ratio=decrease -maxrate:v:1 1600k -bufsize:v:1 2100k -preset fast -b:a:1 128k \
